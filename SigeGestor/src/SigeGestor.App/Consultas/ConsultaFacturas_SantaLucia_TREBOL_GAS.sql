...
(Select idfacturaventacabecera,Codigocontrato from FacturaVentaCabecera with(nolock) where  IdTarifaGrupoXML in 
(select idtarifagrupo from TarifaGrupo where 
textotarifagrupo like '%MIBGAS_AD1 GRUPO SANTA%') 
