--Erick _Gestor Sige_ TREBOL Elec V4
...
FacturasVentaConsulta AS (
    ...
    WHERE fvc.SerieFactura IS NOT NULL AND fvc.FechaFactura >= 'DesdeFechaReplace' and fvc.FechaFactura <= 'hastaFechaReplace'
)
,
ContratoPot as(
select 
...
SELECT 
    ...
    l.PotenciaMaxP6 AS PotenciaMaxPeriodo6
FROM Lectura l
